...
import { brightBlue, brightYellow, brightRed, bold } from "https://deno.land/std@0.174.0/fmt/colors.ts";
import { parse } from "https://deno.land/std@0.174.0/flags/mod.ts";
import { LogLevels } from "https://deno.land/std@0.174.0/log/mod.ts";

export { log, parse, BaseHandler, LogLevels, brightBlue, brightYellow, brightRed, bold };
