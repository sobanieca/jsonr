...
Commands:
  ...
  init        Generate a jsonr example script to get started using jsonr programmatically in your code.
              Usage: jsonr init [url or .http file]

              Allows you to chain multiple requests and handle responses programmatically.
              When you provide an optional URL or .http file path, the generated script will include it as a starting example.

  run         Execute a JavaScript file with the built-in runtime.
              Usage: jsonr run script.js

              This is particularly useful for running scripts generated by 'jsonr init'.
